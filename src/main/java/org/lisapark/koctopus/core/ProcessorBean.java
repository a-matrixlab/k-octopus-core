...
public class ProcessorBean {
    ...
    /**
     * Tolerance value is in the range [0 .. 1], * 0 - no difference, both maps
     * are * the same; * 1 - totally different. * * Processors with a different
     * ClassNames are considered incomparable with * tolerance = null.
     */
    /**
     * * * @param bean * @param threshold * @return
     * @param bean
     * @return 
     */
